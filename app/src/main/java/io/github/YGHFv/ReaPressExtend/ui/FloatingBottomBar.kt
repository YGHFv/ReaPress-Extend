...
import io.github.YGHFv.ReaPressExtend.ui.liquid.DampedDragAnimation
import io.github.YGHFv.ReaPressExtend.ui.liquid.InnerShadow
import io.github.YGHFv.ReaPressExtend.ui.liquid.InteractiveHighlight
import io.github.YGHFv.ReaPressExtend.ui.liquid.innerShadow
import io.github.YGHFv.ReaPressExtend.ui.liquid.rememberCombinedBackdrop
    ...
    Box(modifier = modifier.fillMaxWidth(), contentAlignment = Alignment.CenterStart) {
        Row(
            Modifier
                ...
                .then(
                    if (isBlurEnabled) interactiveHighlight.modifier.then(interactiveHighlight.gestureModifier)
                    else Modifier
                )
